...
if (!defined($const_prefix)) {
    ...
    define($const_prefix . '_C_SITETITLE', 'サイト名');
    define($const_prefix . '_C_SITEDESC', 'サイト概要');
    define($const_prefix . '_C_SITEEMAIL', 'サイトメールアドレス');
    define($const_prefix . '_C_HPURL', 'サイトURL');
