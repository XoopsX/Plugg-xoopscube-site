...
<?php       if (!empty($_TAB['ajax'])):?>
      <h2 class="tab-label"><?php $this->HTML->linkToRemote(h($_TAB['title']), 'plugg-admin', $_TAB['url'], array('params' => array(Plugg::STACK_LEVEL => 4)));?></h2>
<?php       else:?>
...
<?php           $this->HTML->linkToRemote(h($_TAB_PAGE_BREADCRUMB['title']), 'plugg-admin', $_TAB_PAGE_BREADCRUMB['url'], array('params' => array(Plugg::REGION => 'plugg_admin')));?> &gt;
<?php         else:?>
...
<?php endif;?>
<?php print $CONTENT;?>
<div class="clear pluggLink clearfix">Powered by <a href="http://plugg.jp/" alt="Plugg.jp">Plugg</a></div>