...
class Sabai_ErrorHandler_Default extends Sabai_ErrorHandler
{
    ...
    public function handlePHPError($level, $msg, $file, $line, $context)
    {
        if ($level == E_USER_ERROR || error_reporting() & $level) {
            ...
            case E_NOTICE:
            case E_USER_NOTICE:
                $this->_handleError($level, $msg, $file, $line, $context, 'Notice', Sabai_Log::ERROR_PHPNOTICE);
                break;
            case E_WARNING:
            case E_USER_WARNING:
                $this->_handleError($level, $msg, $file, $line, $context, 'Warning', Sabai_Log::ERROR_PHPWARNING);
                break;
            case E_STRICT:
                $this->_handleError($level, $msg, $file, $line, $context, 'Strict', Sabai_Log::ERROR_PHPSTRICT);
                break;
            case E_DEPRECATED:
            case E_USER_DEPRECATED:
                $this->_handleError($level, $msg, $file, $line, $context, 'Deprecated', Sabai_Log::ERROR_PHPDEPRECATED);
                break;
            case E_USER_ERROR:
                $this->_handleError($level, $msg, $file, $line, $context, 'Catchable fatal error', Sabai_Log::ERROR_PHPFATAL);
                $this->_handleFatalError($msg, $file, $line, $context);
                break;
            case E_RECOVERABLE_ERROR:
            default:
                $this->_handleError($level, $msg, $file, $line, $context, 'Fatal error', Sabai_Log::ERROR_PHPFATAL);
                $this->_handleFatalError($msg, $file, $line, $context);
                break;
            }
