...
class Sabai_Model_Criteria
{
    ...
    /**
     * Checks if an entity satisfies the criteria
     *
     * @param Sabai_Model_Entity $entity
     * @return bool
     */
    public function isSatisfiedBy(Sabai_Model_Entity $entity)
    {
    ...
    public static function createComposite($elements = array())
    {
        require_once 'Sabai/Model/Criteria/Composite.php';
        return new Sabai_Model_Criteria_Composite($elements);
    }
