...
<rdf:RDF
 ...
 <channel rdf:about="<?php echo $this->URL->create(array('path' => '/' . $feed->getId() . '/rss'));?>">
  <title><?php _h($feed->title);?> | <?php _h($identity->getUsername());?> | <?php _h($this->Config->get('siteName'));?></title>
  <link><?php echo $this->URL->create(array('path' => '/' . $feed->getId()));?></link>
