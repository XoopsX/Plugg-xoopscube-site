...
pluginsy/Birthday/Model/BirthdayHTMLQuickForm.php
*/
abstract class Plugg_Birthday_Model_Base_BirthdayHTMLQuickForm extends Sabai_Model_EntityHTMLQuickForm
{
    ...
    {
        $vars = array();
        foreach (array('userid' => 'userid') as $var_name => $form_name) {
