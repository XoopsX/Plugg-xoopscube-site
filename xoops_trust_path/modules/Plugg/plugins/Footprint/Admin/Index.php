...
class Plugg_Footprint_Admin_Index extends Sabai_Application_ModelEntityController_Paginate
{
    private $_select;
    private $_sortBy;
    ...
    protected function _getCriteria(Sabai_Application_Context $context)
    {
        ...
        switch($this->_select) {
            case 'hidden':
                $criteria = Sabai_Model_Criteria::createValue('footprint_hidden', 1);
                break;
            default:
                $this->_select = 'all';
                $criteria = false;
    ...
    protected function _onPaginateEntities($entities, Sabai_Application_Context $context)
    {
        ...
        return $entities->with('User')->with('TargetUser');
    }
