...
pluginsy/Footprint/Model/FootprintHTMLQuickForm.php
*/
abstract class Plugg_Footprint_Model_Base_FootprintHTMLQuickForm extends Sabai_Model_EntityHTMLQuickForm
{
    public function onInit(array $params)
    {
        $this->addElement('text', 'target', $this->_model->_('Target'), array('size' => 80, 'maxlength' => 255));
    ...
    {
        $defaults = array();
        foreach (array('target', 'hidden') as $key) {
    ...
    {
        $vars = array();
        foreach (array('target' => 'target', 'hidden' => 'hidden', 'userid' => 'userid') as $var_name => $form_name) {
