...
plugins/Gender/Model/Gender.php
*/
abstract class Plugg_Gender_Model_Base_Gender extends Sabai_Model_Entity
{
    public function __construct(Sabai_Model $model)
    {
        parent::__construct('Gender', $model);
        $this->_vars = array('gender_id' => 0, 'gender_created' => 0, 'gender_updated' => 0, 'gender_gender' => 0, 'gender_userid' => null);
    }
    ...
    {
        return $this->_vars['gender_' . $name];
    }
    ...
    protected function _setVar($name, $value)
    {
        switch ($name) {
        case 'id':
            $this->_vars['gender_id'] = $value;
            break;
        case 'gender':
            $this->_vars['gender_gender'] = $value;
            break;
        case 'userid':
            $this->_vars['gender_userid'] = trim($value);
            break;
        default:
...
abstract class Plugg_Gender_Model_Base_GenderRepository extends Sabai_Model_EntityRepository
{
    public function __construct(Sabai_Model $model)
    {
        parent::__construct('Gender', $model);
    ...
    {
        return $this->_fetchByForeign('gender_userid', $id, $limit, $offset, $sort, $order);
    }
    ...
    {
        return $this->_countByForeign('gender_userid', $id);
    }

    public function fetchByUserAndCriteria($id, Sabai_Model_Criteria $criteria, $limit = 0, $offset = 0, $sort = null, $order = null)
    {
        return $this->_fetchByForeignAndCriteria('gender_userid', $id, $criteria, $limit, $offset, $sort, $order);
    }
    ...
    {
        return $this->_countByForeignAndCriteria('gender_userid', $id, $criteria);
    }

    protected function _getCollectionByRowset(Sabai_DB_Rowset $rs)
    {
        return new Plugg_Gender_Model_Base_GendersByRowset($rs, $this->_model->create('Gender'), $this->_model);
    }

    public function createCollection(array $entities = array())
    {
        return new Plugg_Gender_Model_Base_Genders($this->_model, $entities);
    }
}

class Plugg_Gender_Model_Base_GendersByRowset extends Sabai_Model_EntityCollection_Rowset
{
    public function __construct(Sabai_DB_Rowset $rs, Sabai_Model_Entity $emptyEntity, Sabai_Model $model)
    {
        parent::__construct('Genders', $rs, $emptyEntity, $model);
    }
...
class Plugg_Gender_Model_Base_Genders extends Sabai_Model_EntityCollection_Array
{
    public function __construct(Sabai_Model $model, array $entities = array())
    {
        parent::__construct($model, 'Genders', $entities);
    }
}