...
<table>
  ...
  <tfoot>
    <tr>
      <td colspan="3" class="right"><input type="submit" value="<?php _h($this->_('Update'));?>" /></td>
    </tr>
  </tfoot>
  <tbody>
...
<input type="hidden" name="<?php _h($token_param);?>" value="<?php $this->Token->write($token_name);?>" />
