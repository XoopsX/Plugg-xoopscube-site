...
pluginsy/Project/Model/Project2categoryHTMLQuickForm.php
*/
abstract class Plugg_Project_Model_Base_Project2categoryHTMLQuickForm extends Sabai_Model_EntityHTMLQuickForm
{
    public function onInit(array $params)
    {
        ...
        $this->addElement('selectmodelentity', $this->_model, 'Category', 'Category', $this->_model->_('category'), null, array('size' => 1));
        $this->_onInit($params);
    }
    ...
    {
        $vars = array();
        foreach (array('project_id' => 'Project', 'category_id' => 'Category') as $var_name => $form_name) {
