<rdf:RDF
 ...
 <channel rdf:about="<?php echo $this->URL->create(array('path' => '/' . $project->getId() . '/comments/rss'));?>">
  <title><?php _h($project->name);?> - <?php $this->_e('Recently posted comments');?> | <?php _h($this->Config->get('siteName'));?></title>
  <link><?php echo $this->URL->create(array('path' => '/' . $project->getId() . '/comments'));?></link>
