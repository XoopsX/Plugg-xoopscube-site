...
<rdf:RDF
 ...
 <channel rdf:about="<?php echo $this->URL->create(array('path' => '/links/rss'));?>">
  <title><?php _h($this->Plugin->getNicename());?> - <?php $this->_e('Recently submitted links');?> | <?php _h($this->Config->get('siteName'));?></title>
  <link><?php if(!$link_type_requested):?><?php echo $this->URL->create(array('path' => '/links'));?><?php else:?><?php echo $this->URL->create(array('path' => '/links', 'params' => array('link_type' => $link_type_requested)));?><?php endif;?></link>
