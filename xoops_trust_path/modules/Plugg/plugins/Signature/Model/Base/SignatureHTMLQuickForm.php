<?php
abstract class Plugg_Signature_Model_Base_SignatureHTMLQuickForm extends Sabai_Model_EntityHTMLQuickForm
{
    public function onInit(array $params)
    {
        $this->addElement('static', 'text', $this->_model->_('Text'));
        $this->addElement('static', 'text_filtered', $this->_model->_('Text filtered'));
        $this->addElement('static', 'text_filter_id', $this->_model->_('Text filter id'));
