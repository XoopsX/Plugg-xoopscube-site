...
pluginsy/User/Model/ActivewidgetHTMLQuickForm.php
*/
abstract class Plugg_User_Model_Base_ActivewidgetHTMLQuickForm extends Sabai_Model_EntityHTMLQuickForm
{
    ...
    {
        $vars = array();
        foreach (array('widget_id' => 'Widget') as $var_name => $form_name) {
