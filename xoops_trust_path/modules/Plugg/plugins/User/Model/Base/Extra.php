...
plugins/User/Model/Extra.php
*/
abstract class Plugg_User_Model_Base_Extra extends Sabai_Model_Entity
{
...
abstract class Plugg_User_Model_Base_ExtraRepository extends Sabai_Model_EntityRepository
{
    public function __construct(Sabai_Model $model)
    {
        parent::__construct('Extra', $model);
    ...
    {
        return new Plugg_User_Model_Base_ExtrasByRowset($rs, $this->_model->create('Extra'), $this->_model);
    }

    public function createCollection(array $entities = array())
    {
        return new Plugg_User_Model_Base_Extras($this->_model, $entities);
    }
}

class Plugg_User_Model_Base_ExtrasByRowset extends Sabai_Model_EntityCollection_Rowset
{
...
class Plugg_User_Model_Base_Extras extends Sabai_Model_EntityCollection_Array
{
