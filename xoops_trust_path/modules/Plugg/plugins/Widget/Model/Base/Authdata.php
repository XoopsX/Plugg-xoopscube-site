...
plugins/Widget/Model/Authdata.php
*/
abstract class Plugg_Widget_Model_Base_Authdata extends Sabai_Model_Entity
{
...
abstract class Plugg_Widget_Model_Base_AuthdataRepository extends Sabai_Model_EntityRepository
{
    public function __construct(Sabai_Model $model)
    {
        parent::__construct('Authdata', $model);
    ...
    {
        return new Plugg_Widget_Model_Base_AuthdatasByRowset($rs, $this->_model->create('Authdata'), $this->_model);
    }

    public function createCollection(array $entities = array())
    {
        return new Plugg_Widget_Model_Base_Authdatas($this->_model, $entities);
    }
}

class Plugg_Widget_Model_Base_AuthdatasByRowset extends Sabai_Model_EntityCollection_Rowset
{
...
class Plugg_Widget_Model_Base_Authdatas extends Sabai_Model_EntityCollection_Array
{
