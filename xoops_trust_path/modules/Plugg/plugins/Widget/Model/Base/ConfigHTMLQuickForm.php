...
pluginsy/Widget/Model/ConfigHTMLQuickForm.php
*/
abstract class Plugg_Widget_Model_Base_ConfigHTMLQuickForm extends Sabai_Model_EntityHTMLQuickForm
{
    public function onInit(array $params)
    {
        ...
        $this->addElement('selectmodelentity', $this->_model, 'Layout', 'Layout', $this->_model->_('layout'), null, array('size' => 1));
        $this->_onInit($params);
    }
    ...
    public function onEntity(Sabai_Model_Entity $entity)
    {
        ...
        if ($this->elementExists('Layout')) {
            $defaults['Layout'] = $entity->getVar('layout_id');
        }
    ...
    {
        $vars = array();
        foreach (array('widget_id' => 'Widget', 'layout_id' => 'Layout') as $var_name => $form_name) {
