...
plugins/Widget/Model/Menu.php
*/
abstract class Plugg_Widget_Model_Base_Menu extends Sabai_Model_Entity
{
...
abstract class Plugg_Widget_Model_Base_MenuRepository extends Sabai_Model_EntityRepository
{
    public function __construct(Sabai_Model $model)
    {
        parent::__construct('Menu', $model);
    ...
    {
        return new Plugg_Widget_Model_Base_MenusByRowset($rs, $this->_model->create('Menu'), $this->_model);
    }

    public function createCollection(array $entities = array())
    {
        return new Plugg_Widget_Model_Base_Menus($this->_model, $entities);
    }
}

class Plugg_Widget_Model_Base_MenusByRowset extends Sabai_Model_EntityCollection_Rowset
{
...
class Plugg_Widget_Model_Base_Menus extends Sabai_Model_EntityCollection_Array
{
