...
plugins/Widget/Model/Role.php
*/
abstract class Plugg_Widget_Model_Base_Role extends Sabai_Model_Entity
{
...
abstract class Plugg_Widget_Model_Base_RoleRepository extends Sabai_Model_EntityRepository
{
    public function __construct(Sabai_Model $model)
    {
        parent::__construct('Role', $model);
    ...
    {
        return new Plugg_Widget_Model_Base_RolesByRowset($rs, $this->_model->create('Role'), $this->_model);
    }

    public function createCollection(array $entities = array())
    {
        return new Plugg_Widget_Model_Base_Roles($this->_model, $entities);
    }
}

class Plugg_Widget_Model_Base_RolesByRowset extends Sabai_Model_EntityCollection_Rowset
{
...
class Plugg_Widget_Model_Base_Roles extends Sabai_Model_EntityCollection_Array
{
