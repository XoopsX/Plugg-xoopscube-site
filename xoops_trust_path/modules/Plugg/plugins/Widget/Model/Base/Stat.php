...
plugins/Widget/Model/Stat.php
*/
abstract class Plugg_Widget_Model_Base_Stat extends Sabai_Model_Entity
{
...
abstract class Plugg_Widget_Model_Base_StatRepository extends Sabai_Model_EntityRepository
{
    public function __construct(Sabai_Model $model)
    {
        parent::__construct('Stat', $model);
    ...
    {
        return new Plugg_Widget_Model_Base_StatsByRowset($rs, $this->_model->create('Stat'), $this->_model);
    }

    public function createCollection(array $entities = array())
    {
        return new Plugg_Widget_Model_Base_Stats($this->_model, $entities);
    }
}

class Plugg_Widget_Model_Base_StatsByRowset extends Sabai_Model_EntityCollection_Rowset
{
...
class Plugg_Widget_Model_Base_Stats extends Sabai_Model_EntityCollection_Array
{
