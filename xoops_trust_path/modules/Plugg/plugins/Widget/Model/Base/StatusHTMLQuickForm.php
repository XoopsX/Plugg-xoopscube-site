...
pluginsy/Widget/Model/StatusHTMLQuickForm.php
*/
abstract class Plugg_Widget_Model_Base_StatusHTMLQuickForm extends Sabai_Model_EntityHTMLQuickForm
{
    public function onInit(array $params)
    {
        $this->addElement('textarea', 'text', $this->_model->_('Text'), array('rows' => 10, 'cols' => 60));
        $this->addElement('textarea', 'text_filtered', $this->_model->_('Text filtered'), array('rows' => 10, 'cols' => 60));
    ...
    {
        $defaults = array();
        foreach (array('text', 'text_filtered') as $key) {
    ...
    {
        $vars = array();
        foreach (array('text' => 'text', 'text_filtered' => 'text_filtered', 'userid' => 'userid') as $var_name => $form_name) {
