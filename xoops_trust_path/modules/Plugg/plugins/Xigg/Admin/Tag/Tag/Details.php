...
class Plugg_Xigg_Admin_Tag_Tag_Details extends Sabai_Application_ModelEntityController_Read
{
    public function __construct()
    {
        parent::__construct('Tag', 'tag_id', array('errorUrl' => array('path' => '/tag')));
    }
    ...
    protected function _onReadEntity(Sabai_Model_Entity $entity, Sabai_Application_Context $context)
    {
        ...
        $this->_application->setData(array(
            'node_entities'       => $pages->getValidPage($page_num)->getElements()->with('User')->with('Category'),
            'node_select'         => $select,
