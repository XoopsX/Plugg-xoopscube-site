...
pluginsy/Xigg/Model/CategoryHTMLQuickForm.php
*/
abstract class Plugg_Xigg_Model_Base_CategoryHTMLQuickForm extends Sabai_Model_EntityHTMLQuickForm
{
    public function onInit(array $params)
    {
        ...
        $this->addElement('selectmodeltreeentity', $this->_model, 'Category', ' - ', 'Parent', $this->_model->_('Parent category'), null, array('size' => 1));
        $this->_onInit($params);
    }
