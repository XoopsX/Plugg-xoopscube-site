...
pluginsy/Xigg/Model/CommentHTMLQuickForm.php
*/
abstract class Plugg_Xigg_Model_Base_CommentHTMLQuickForm extends Sabai_Model_EntityHTMLQuickForm
{
    public function onInit(array $params)
    {
        ...
        $this->addElement('selectmodeltreeentity', $this->_model, 'Comment', ' - ', 'Parent', $this->_model->_('Parent comment'), null, array('size' => 1));
    ...
    {
        $defaults = array();
        foreach (array('title', 'body', 'allow_edit') as $key) {
    ...
    {
        $vars = array();
        foreach (array('title' => 'title', 'body' => 'body', 'allow_edit' => 'allow_edit', 'node_id' => 'Node', 'parent' => 'Parent', 'userid' => 'userid') as $var_name => $form_name) {
